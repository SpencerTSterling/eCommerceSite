...
namespace eCommerceSite.Models
{
    public static class CookieHelper
    {
        ...
        /// <summary>
        /// Returns the current list of cartProducts
        /// if cart is empty, an empty list is returned
        /// </summary>
        ...
        public static void AddProductToCart(HttpContextAccessor http, Product p)
        {
